...
class DETRClass:
    ...
    def plot_bboxes(self, results, frame):
        ...
        for xyxy, mask, confidence, class_id, track_id, *_ in detections:
...
transformer_detector = DETRClass(0, detection_interval=100, output_folder="onpremise/recorder/screenshot")
